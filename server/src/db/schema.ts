...
export const marks = pgTable(
  ...
  (t) => [index("marks_user_marked_at_idx").on(t.userId, t.markedAt)]
);
...
export const accesses = pgTable(
  ...
  (t) => [index("accesses_mark_accessed_at_idx").on(t.markId, t.accessedAt)]
);
...
export const captures = pgTable(
  ...
  (t) => [index("captures_access_order_idx").on(t.accessId, t.order)]
);
